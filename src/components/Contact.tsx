...
export function Contact() {
  ...
  const handlePhoneClick = () => {
    ...
    // Create tel: link to open dialer
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    onChange={handleInputChange} 
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500" 
                    placeholder={isBooking ? 'Please include your preferred dates and number of guests' : 'Your message'} 
                    required 
                    disabled={isLoading}
                  ></textarea>
                </div>
                ...
                <div>
                  <button 
                    type="submit" 
                    className="w-full bg-emerald-700 text-white px-6 py-3 rounded-md font-medium hover:bg-emerald-600 transition-colors duration-300 flex justify-center items-center" 
                    disabled={isLoading}
                  >
                    {isLoading ? (
                      <>
          ...
          <div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <button 
                      ...
                      className="text-gray-700 hover:text-emerald-700 transition-colors duration-200 text-left"
                    >
                      {phoneNumber}
                    </button>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <div id="location-map" className="h-64 rounded-lg overflow-hidden" style={{ position: 'relative' }}>
                {/* Map will be loaded here */}
              </div>
              <div className="mt-4 text-center">
                <a 
                  href="https://www.google.com/maps/place//@6.951067,80.7815444,18z/data=!4m6!1m5!3m4!2zNsKwNTcnMDMuNiJOIDgwwrA0Nic1OC4zIkU!8m2!3d6.9510004!4d80.7828533?hl=en&entry=ttu" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="inline-block text-emerald-700 hover:text-emerald-600 underline font-medium"
                >
                  View on Google Maps
                </a>
              </div>
